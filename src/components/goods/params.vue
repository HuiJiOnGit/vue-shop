    ...
    <el-card>
      ...
      <el-row class="cat_opt">
        <el-col class="cat_col1">
          <span>选择商品分类：</span>
          <!-- 选择商品分类的级联选择框 -->
          <el-cascader v-model="cateSelectValue" :options="catelist" :props="cateProps" @change="handleChange"
      ...
      <el-tabs v-model="activeName" @tab-click="handleTabClick">
        <el-tab-pane label="动态参数" name="many">
          <el-button type="primary" size="medium" :disabled="isBtnDisable" @click="addParamsDialogVisible = true">添加动态参数
          </el-button>
          <el-table :data="manyTableData" border stripe>
            <el-table-column type="expand">
              <template v-slot:default="scope">
                <!-- 循环生成tag -->
                <el-tag v-for="(item,key) in scope.row.attr_vals" :key="key" closable @close="handleClose(key,scope.row)">{{item}}</el-tag>
                <!-- 生成添加按钮 -->
            ...
            <el-table-column label="操作">
              <template v-slot:default="scope">
                <el-button size="mini" type="primary" icon="el-icon-edit" @click="OpenEditDialog(scope.row.attr_id)">编辑
                </el-button>
                <el-button size="mini" type="danger" icon="el-icon-delete" @click="DeleteParamsById(scope.row.attr_id)">
                  删除</el-button>
              </template>
            </el-table-column>
          </el-table>
        ...
        <el-tab-pane label="静态属性" name="only">
          <el-button type="primary" size="medium" :disabled="isBtnDisable" @click="addParamsDialogVisible = true">添加静态属性
          </el-button>
